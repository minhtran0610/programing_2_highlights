        ...
        if(command == "U" or command == "u") {
            ...
            if (student_numbers.find(student_number) == student_numbers.end()) {
                ...
                if (is_valid_phone_number(number)) {
                    Student* student_ptr = student_numbers.at(student_number);
                    student_ptr->phone_number = number;
            ...
            auto iter = user_ids.begin();
            while (iter != user_ids.end()) {
                data_file << iter->second->student_number << ";" << iter->second->user_id << ";" << iter->second->name << ";"
                          << iter->second->phone_number << ";" << iter->second->email << ";" << iter->second->skype << std::endl;
                ++iter;
            }
            data_file.close();
